    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                @if ($item->gambar)
                <img src="{{ asset('storage/'.$item->gambar)}}" class=" w-100" alt="..." style="height: 650px">
                @else
                <img src="style/img/download.png" class=" w-100" alt="..." style="height: 650px">
                @endif

                <div class="carousel-caption">
                    <h1 class="display-5"><a href="/profildesapages/{{$item->id}}" class="text-light" style="text-decoration: none">{{$item->nama}}</a></h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center my-5">
                    <img src="storage/{{$docs->gambar}}" alt="" width="200">
                </div>
                <div class="col my-5">
                    <p class="text-uppercase text-right mb-4">{{$docs->judul}}</p>
    ...
    <div class="container-fluid bg-secondary desa">
        ...
        <div class="row mt-4">
            <div class="col text-center">
                <a href="/profildesapages/{{$pd->id}}" class="text-white">{{$pd->nama}}</a> <br>
