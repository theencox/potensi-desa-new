...
<div class="container-fluid">
    ...
    <div class="kritikdansaran my-3">
        ...
        <form method="post" action="/kritikdansaranpages">
            @csrf
            <div class="form-group mb-3 ml-4">
                <label for="nama" class="form-label">Nama</label>
                <input type="text" autocomplete="off" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukkan Nama" name="nama" value="{{old('nama')}}">
                @error('nama')
            ...
            <div class="form-group mb-3 ml-4">
                ...
                <input type="email" autocomplete="off" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan Email" name="email" value="{{old('email')}}">
                @error('email')
                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                    {{$message}}.
                </div>
            ...
            <div class="form-group mb-3 ml-4">
                ...
                <textarea type="text" class="form-control ckeditor @error('deskripsi') is-invalid @enderror" rows="5" id="ckeditor" placeholder="Masukkan Deskripsi" name="deskripsi">{{old('deskripsi')}}</textarea>
                @error('deskripsi')
                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                    {{$message}}.
                </div>
